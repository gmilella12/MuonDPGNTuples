...
```
        muNtupleProducer (TDirectory)
                MuDPGTree (TTree)
                        ...
                        gemSimHit_particleType (TBranchElement)
                        gemSimHit_energyLoss (TBranchElement)
                        gemSimHit_TOF (TBranchElement)
                        gemSimHit_detUnitId (TBranchElement)
                        gemSimHit_trackId (TBranchElement)
                        gemSimHit_eventId (TBranchElement)
                        gemSimHit_processType (TBranchElement)
                        gemSimHit_bunchCrossing (TBranchElement)
                        gemSimHit_loc_r (TBranchElement)
                        gemSimHit_loc_phi (TBranchElement)
                        gemSimHit_loc_x (TBranchElement)
                        gemSimHit_loc_y (TBranchElement)
                        gemSimHit_loc_z (TBranchElement)
                        gemSimHit_g_r (TBranchElement)
                        gemSimHit_g_phi (TBranchElement)
                        gemSimHit_g_x (TBranchElement)
                        gemSimHit_g_y (TBranchElement)
                        gemSimHit_g_z (TBranchElement)
                        genParticle_PdgId (TBranchElement)
                        genParticle_Pt (TBranchElement)
                        genParticle_Eta (TBranchElement)
                        genParticle_Phi (TBranchElement)
                        genParticle_vx (TBranchElement)
                        genParticle_vy (TBranchElement)
                        genParticle_vz (TBranchElement)
                        genParticle_MotherPdgId (TBranchElement)
                        genParticle_GrandMotherPdgId (TBranchElement)
                        ...
                        mu_propagated_EtaPartition_rSpan_ (TBranchElement)
                        mu_propagated_EtaPartition_phiSpan_ (TBranchElement)
